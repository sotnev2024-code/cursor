...
if __name__ == '__main__':
    ...
    print(f'📊 API доступен по адресу http://0.0.0.0:{port}/api')
    print(f'📄 Фронтенд доступен по адресу http://0.0.0.0:{port}/')
    print(f'📱 Мини-приложение доступно по адресу http://0.0.0.0:{port}/miniaps/')
    
    # В production режиме (когда PORT установлен) отключаем debug
    debug_mode = os.environ.get('FLASK_ENV') != 'production' and port == 5000
