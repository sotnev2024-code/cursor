...
class ApiService {
    ...
    async request(endpoint, options = {}) {
        ...
        console.log('API Request - Base URL:', this.baseUrl, 'Endpoint:', endpoint, 'Initial URL:', url);
        console.log('Window location origin:', window.location.origin, 'Protocol:', window.location.protocol);
